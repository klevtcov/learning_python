...
# Строка документации доступна в качестве метода .__doc__
# большинство стандартных библиотек имеют метод док - os.__doc__
# help(os) - альтернативный метод вывода описания документации

class RandomIterator:
    '''
    RandomIterator(k) - new iterator for k rtandom numbers in [0, 1)
